...
from lvdm_tvg_single.models.utils_diffusion import timestep_embedding
from lvdm_tvg_single.common import checkpoint
from lvdm_tvg_single.basics import (
    zero_module,
    conv_nd,
    linear,
    avg_pool_nd,
...
from lvdm_tvg_single.modules.attention import SpatialTransformer, TemporalTransformer
...
class UNetModel(nn.Module):
    ...
    def forward(self, x, timesteps, context=None, features_adapter=None, fs=None, **kwargs):
        ...
        if len(context.shape)==4:
            context = rearrange(context, 'b l t c -> (b t) l c')
        else:
